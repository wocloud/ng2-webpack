...
var MenuService = (function () {
    ...
    MenuService.prototype._skipEmpty = function (items) {
        var menu = [];
    ...
    MenuService.prototype._convertArrayToItems = function (routes, parent) {
        var _this = this;
        var items = [];
    ...
    MenuService.prototype._convertObjectToItem = function (object, parent) {
        var item = {};
    ...
    MenuService.prototype._prepareItem = function (object) {
        if (!object.skip) {
